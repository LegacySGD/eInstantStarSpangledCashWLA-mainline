...
public class StarSpangledCashWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(StarSpangledCashWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/StarSpangledCashWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/StarSpangledCashWLAIW/InitOutcome.xml").getDocumentElement();
